                                        ...
                                        <div className="flex flex-col gap-3">
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <button
                                                    ...
                                                    className="py-3 rounded-xl border border-gray-200 dark:border-dark-border text-gray-700 dark:text-gray-300 font-bold flex items-center justify-center gap-1.5 hover:bg-gray-50 dark:hover:bg-dark-border/80 transition-colors text-sm min-w-0"
                                                >
                                                    <FiShare2 size={15} className="flex-shrink-0" />
                                                    <span className="truncate">Share PDF</span>
                                                </button>
                                            </div>
                                            <a
                                                href="tel:+919000000000"
                                                className="w-full py-3 rounded-xl border-2 border-gold-400 text-gold-400 font-bold flex items-center justify-center gap-1.5 hover:bg-gold-400/10 active:bg-gold-400/20 transition-colors text-sm min-w-0"
                                            >
